...
function client.setPlayerStatus(values)
	for name, value in pairs(values) do
		...
		if name == "hunger" then
			TriggerServerEvent('consumables:server:addHunger', Core.Functions.GetPlayerData().metadata.hunger + value)
		elseif name == "thirst" then
			TriggerServerEvent('consumables:server:addThirst', Core.Functions.GetPlayerData().metadata.thirst + value)
