...
local function setupPlayer(Player)
	...
	Core.Functions.AddPlayerMethod(Player.PlayerData.source, "GetItemByName", function(itemName)
		return setItemCompatibilityProps(Inventory.GetSlotWithItem(Player.PlayerData.source, itemName))
	end)

	Core.Functions.AddPlayerMethod(Player.PlayerData.source, "GetItemsByName", function(itemName)
	...
	Core.Functions.AddPlayerMethod(Player.PlayerData.source, "SetInventory", function()
...
SetTimeout(500, function()
	...
	for _, Player in pairs(Core.Functions.GetQBPlayers()) do setupPlayer(Player) end
end)
