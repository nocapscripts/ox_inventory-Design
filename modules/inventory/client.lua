...
Inventory.Dumpsters = json.decode(Config.Dumpsters)
                        ...
                        stash.zoneId = Utils.CreateBoxZone(stash.target, {
                            {
                                ...
                                groups = stash.groups,
                                onSelect = function()
                                    exports.inventory:openInventory('stash', stash.name)
                                end,
...
RegisterNetEvent('inventory:refreshMaxWeight', function(data)
...
RegisterNetEvent('inventory:refreshSlotCount', function(data)
	SendNUIMessage({
		action = 'refreshSlots',
		data = {
			slotsData = {
